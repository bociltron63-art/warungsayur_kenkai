            ...
            <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center rounded-xl border border-border">
                <button
                  ...
                  className="w-8 h-9 flex items-center justify-center text-stone-600 hover:text-kk-green"
                >
                  <Minus className="w-3.5 h-3.5" />
                </button>
                <span className="w-6 text-center text-sm font-bold" data-testid={`card-qty-${product.id}`}>{qty}</span>
                <button
              ...
              <button
                ...
                onClick={handleAdd}
                className="flex-1 inline-flex items-center justify-center gap-1 py-2.5 rounded-xl bg-kk-green text-white text-sm font-semibold hover:bg-kk-dark active:scale-95 transition-all"
              >
